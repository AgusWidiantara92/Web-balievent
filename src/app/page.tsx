...
export default async function Home() {
  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      {/* 4. Section Event Populer */}
      <section className="py-20 bg-white dark:bg-[#121214]">
        <Container>
          ...
          {popularEvents.length === 0 ? (
            <div className="p-16 text-center max-w-md mx-auto space-y-4 bg-bali-sand/10 dark:bg-bali-charcoal/10 border border-gray-150 dark:border-gray-800 rounded-3xl shadow-sm">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {popularEvents.map((evt) => (
                <div
                  key={evt.id}
                  className="flex flex-col bg-white dark:bg-[#1c1c21] rounded-2xl border border-gray-200/60 dark:border-gray-800/80 overflow-hidden shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all"
                >
                  {/* Poster */}
      ...
      {/* 5. Section Kategori Event */}
      <section className="py-20 bg-bali-sand/20 dark:bg-[#0c0c0e] border-y border-gray-100 dark:border-gray-800/60">
        <Container>
