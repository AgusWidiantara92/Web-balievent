...
export function CreateEventForm({ categories, locations }: CreateEventFormProps) {
  ...
  return (
    <div className="space-y-6 max-w-4xl mx-auto">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        ...
        <div className="flex items-center gap-2 text-xs font-bold text-teal-600 dark:text-teal-400 bg-teal-50 dark:bg-teal-950/30 px-3 py-1.5 rounded-full border border-teal-100 dark:border-teal-900/30">
          <Sparkles className="h-3 w-3 animate-pulse" />
          Status Event Baru: PENDING (Menunggu Persetujuan Admin)
        </div>
      </div>
      ...
      <form action={formAction} className="bg-white dark:bg-[#1c1c21] rounded-3xl p-6 sm:p-10 shadow-xl border border-gray-150/40 dark:border-gray-800/80 space-y-8">
        ...
        <div className="space-y-6">
          <div className="border-b border-gray-100 dark:border-gray-800 pb-3">
            ...
            <p className="text-xs text-gray-400 dark:text-gray-500 mt-1">
              Masukkan detail acara budaya atau pariwisata yang menarik bagi wisatawan.
            </p>
          </div>
          ...
          <div className="space-y-4">
            <div className="space-y-2">
              ...
              <p className="text-[11px] text-gray-400">
                Gunakan URL gambar Unsplash atau tautan gambar daring yang valid untuk sementara waktu.
              </p>
              {state?.errors?.poster && (
                <p className="text-xs text-red-600 dark:text-red-400 font-bold flex items-center gap-1">
                  <AlertCircle className="h-3 w-3" />
        ...
        <div className="space-y-6">
          <div className="border-b border-gray-100 dark:border-gray-800 pb-3">
            ...
            <p className="text-xs text-gray-400 dark:text-gray-500 mt-1">
              Atur waktu mulai dan berakhirnya acara secara presisi.
            </p>
          </div>
        ...
        {/* Action Buttons */}
        <div className="border-t border-gray-100 dark:border-gray-800 pt-6 flex flex-col sm:flex-row justify-end items-center gap-3">
          <Link
            href="/dashboard/organizer"
